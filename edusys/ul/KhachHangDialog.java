...
public class KhachHangDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnthem);
        btnthem.setBounds(40, 490, 117, 40);
        ...
        jPanel1.add(btnPrev);
        btnPrev.setBounds(210, 540, 97, 39);
        ...
        jPanel1.add(btnxoa);
        btnxoa.setBounds(360, 490, 105, 39);

        btnmoi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/circular.png"))); // NOI18N
        btnmoi.setText("Mới ");
        ...
        jPanel1.add(btnmoi);
        btnmoi.setBounds(530, 490, 100, 39);
        ...
        jPanel1.add(btnsua);
        btnsua.setBounds(210, 490, 97, 39);
        ...
        btnFirst.setBounds(40, 540, 117, 39);
        ...
        jPanel1.add(btnNext);
        btnNext.setBounds(360, 540, 105, 39);
        ...
        jPanel1.add(btnLast);
        btnLast.setBounds(530, 540, 100, 39);
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/magnifier.png"))); // NOI18N
